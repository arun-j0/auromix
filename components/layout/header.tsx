...
import { Building2, Users, Package, ClipboardList, BarChart3, Home, UserCheck, FileText } from "lucide-react"
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-white border border-gray-200 shadow-lg">
              {navItems.map((item) => {
                ...
                return (
                  <Link key={item.name} href={item.href}>
                    <DropdownMenuItem className={`hover:bg-gray-50 ${isActive ? "bg-blue-50 text-blue-600" : ""}`}>
